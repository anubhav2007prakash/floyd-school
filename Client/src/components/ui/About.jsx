      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Floyd School Description */}
            <p className="text-lg text-slate-300 mb-6 leading-relaxed max-w-xl lg:max-w-none mx-auto lg:mx-0 font-medium">
              <span className="font-bold text-white">Floyd School</span> is a school-integrated STEM education program designed to make
          ...
          >
            <GlowingCard>
              ...
              {/* Feature List (Updated to reflect Floyd School's approach) */}
