...
const ROADMAP_STEPS = [
  {
    step: '01',
    badge: 'DAY 1',
    title: 'COMPLIMENTARY TECHNOLOGY IMMERSION',
    description: 'Students experience hands on technology learning and discover what excites them.',
    side: 'left',
    icon: Compass,
    color: '#3B82F6',
    badgeBg: '#e0f2fe',
  ...
  },
  {
    ...
    description: 'Students explore technology domains and identify the areas they want to develop further.',
    side: 'right',
    icon: CheckCircle,
    color: '#6366F1',
    badgeBg: '#e0e7ff',
  ...
  },
  {
    step: '03',
    badge: '4 MONTHS',
    title: 'IN SCHOOL TECHNOLOGY PROGRAM',
    description: 'Mentor led sessions, practical assignments, real projects and continuous progress tracking.',
    side: 'left',
    icon: Calendar,
    color: '#8B5CF6',
    badgeBg: '#f3e8ff',
  ...
  },
  {
    ...
    description: 'Students turn what they learn into projects they can present, improve and showcase.',
    side: 'right',
    icon: Trophy,
    color: '#EC4899',
    badgeBg: '#fce7f3',
  ...
  },
  {
    ...
    description: 'Students complete their learning journey with a Floyd School certificate and opportunities to showcase their work.',
    side: 'left',
    icon: Award,
    color: '#10B981',
    badgeBg: '#d1fae5',
