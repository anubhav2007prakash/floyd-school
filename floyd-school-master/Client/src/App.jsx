    ...
    return (
        <div>
            ...
            <Routes>
                ...
                {/* Hackathon Page & Portals */}
                <Route path='/hackathon' element={<HackathonPage />} />
                <Route path='/school' element={<Navigate to="/hackathon?view=school" replace />} />
                <Route path='/participants' element={<Navigate to="/hackathon?view=participant" replace />} />
